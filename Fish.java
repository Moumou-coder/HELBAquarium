...
public abstract class Fish extends MovingGameElement {
    ...
    protected int index;
    protected final int SHORT_RANGE_DISTANCE = 50;
    protected final int LONG_RANGE_DISTANCE = 100;
...
//    }
    ...
    protected void fishBehaviour(Board board, MovingGameElement mvElemOther, ArrayList<Integer> tempoX, ArrayList<Integer> tempoY, ArrayList<Double> tempoDistance, boolean isMax, int range) {
